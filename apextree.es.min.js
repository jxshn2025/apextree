...
register(Box, "Box");
let List$2 = class List extends Array {
...
List$2.extend = function(methods2) {
...
extend(Circle, { x: x$3, y: y$3, cx: cx$1, cy: cy$1, width: width$3, height: height$2 });
registerMethods({
  Container: {
...
function width$1(width2, box = this.bbox()) {
  if (width2 == null)
    return box.width;
...
function buildState(g, weightFn) {
  ...
  let buckets = range$1(maxOut + maxIn + 3).map(() => new List3());
  let zeroIdx = maxIn + 1;
