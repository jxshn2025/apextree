...
const descriptiveElements$1 = /* @__PURE__ */ new Set(["desc", "metadata", "title"]);
const isDescriptive$1 = (element) => descriptiveElements$1.has(element.nodeName);
const writeDataToDom$1 = (element, data2, defaults = {}) => {
  const cloned = { ...data2 };
...
const html$1 = "http://www.w3.org/1999/xhtml";
const xmlns$1 = "http://www.w3.org/2000/xmlns/";
const xlink$1 = "http://www.w3.org/1999/xlink";
const globals$1 = {
...
const numberAndUnit$1 = /^([+-]?(\d+(\.\d*)?|\.\d+)(e[+-]?\d+)?)([a-z%]*)$/i;
const hex$1 = /^#?([a-f\d]{2})([a-f\d]{2})([a-f\d]{2})$/i;
const rgb$1 = /rgb\((\d+),(\d+),(\d+)\)/;
const reference$1 = /(#[a-z_][a-z0-9\-_]*)/i;
const transforms$1 = /\)\s*,?\s*/;
const whitespace$1 = /\s/g;
const isHex$1 = /^#[a-f0-9]{3}$|^#[a-f0-9]{6}$/i;
const isRgb$1 = /^rgb\(/;
const isBlank$1 = /^(\s+)?$/;
const isNumber$1 = /^[+-]?(\d+(\.\d*)?|\.\d+)(e[+-]?\d+)?$/i;
const isImage$1 = /\.(jpg|jpeg|png|gif|svg)(\?[^=]+.*)?/i;
const delimiter$1 = /[\s,]+/;
const isPathLetter$1 = /[MLHVCSQTAZ]/i;
function classes$1() {
...
let List$3 = class List extends Array {
...
const reserved$1 = ["toArray", "constructor", "each"];
...
let EventTarget$1 = class EventTarget extends Base$1 {
  addEventListener() {
  }
...
let SVGArray$1 = class SVGArray extends Array {
  constructor(...args) {
    super(...args);
    this.init(...args);
  }
...
let SVGNumber$1 = class SVGNumber {
  // Initialize
  constructor(...args) {
    this.init(...args);
  }
...
const colorAttributes$1 = /* @__PURE__ */ new Set([
  "fill",
  "stroke",
  "color",
  "bgcolor",
...
let Dom$1 = class Dom extends EventTarget$1 {
...
let Element$1 = class Element extends Dom$1 {
  constructor(node, attrs2) {
    super(node, attrs2);
    this.dom = {};
  ...
  // Get parent document
  root() {
    const p = this.parent(getClass$1(root$2));
    return p && p.root();
  }
...
let Defs$1 = class Defs extends Container$1 {
...
const circled$1 = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  __proto__: null,
  cx: cx$3,
  cy: cy$3,
  height: height$5,
...
let Ellipse$1 = class Ellipse extends Shape$1 {
  constructor(node, attrs2 = node) {
...
let Fragment$1 = class Fragment extends Dom$1 {
...
const gradiented$1 = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  __proto__: null,
  from: from$1,
  to: to$1
}, Symbol.toStringTag, { value: "Module" }));
let Gradient$1 = class Gradient extends Container$1 {
...
let Pattern$1 = class Pattern extends Container$1 {
  // Initialize node
  constructor(node, attrs2 = node) {
...
let PointArray$1 = class PointArray extends SVGArray$1 {
...
const MorphArray$1 = PointArray$1;
function x$6(x2) {
...
const pointed$1 = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  __proto__: null,
...
let Line$1 = class Line extends Shape$1 {
  // Initialize node
  constructor(node, attrs2 = node) {
...
let Marker$1 = class Marker extends Container$1 {
  // Initialize node
  constructor(node, attrs2 = node) {
...
let Stepper$1 = class Stepper {
  done() {
    return false;
  }
};
let Ease$1 = class Ease extends Stepper$1 {
...
let Controller$1 = class Controller extends Stepper$1 {
  constructor(fn) {
    super();
    this.stepper = fn;
  }
...
let Spring$1 = class Spring extends Controller$1 {
...
let PID$1 = class PID extends Controller$1 {
...
const mlhvqtcsaz$1 = "mlhvqtcsaz".split("");
...
const pathDelimiters$1 = /* @__PURE__ */ new Set([" ", ",", "	", "\n", "\r", "\f"]);
...
let PathArray$1 = class PathArray extends SVGArray$1 {
...
let Morphable$1 = class Morphable {
  constructor(stepper) {
...
let NonMorphable$1 = class NonMorphable {
  constructor(...args) {
    this.init(...args);
  }
  init(val) {
...
let TransformBag$1 = class TransformBag {
  constructor(...args) {
    this.init(...args);
  }
  init(obj) {
...
const sortByKey$1 = (a, b) => {
  return a[0] < b[0] ? -1 : a[0] > b[0] ? 1 : 0;
};
let ObjectBag$1 = class ObjectBag {
  constructor(...args) {
    this.init(...args);
  }
  align(other) {
...
const morphableTypes$1 = [NonMorphable$1, TransformBag$1, ObjectBag$1];
...
let Path$1 = class Path extends Shape$1 {
  // Initialize node
  constructor(node, attrs2 = node) {
...
const poly$1 = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  __proto__: null,
  array: array$1,
  clear: clear$1,
  move: move$5,
...
let Polygon$1 = class Polygon extends Shape$1 {
  // Initialize node
  constructor(node, attrs2 = node) {
...
let Polyline$1 = class Polyline extends Shape$1 {
  // Initialize node
  constructor(node, attrs2 = node) {
...
let Rect$1 = class Rect extends Shape$1 {
  // Initialize node
  constructor(node, attrs2 = node) {
...
const makeSchedule$1 = function(runnerInfo) {
...
const defaultSource$1 = function() {
  const w = globals$1.window;
  return (w.performance || w.Date).now();
};
let Timeline$1 = class Timeline extends EventTarget$1 {
...
let Runner$1 = class Runner extends EventTarget$1 {
  constructor(options) {
    super();
    this.id = Runner.id++;
...
Runner$1.id = 0;
let FakeRunner$1 = class FakeRunner {
...
const lmultiply$1 = (last, curr) => last.lmultiplyO(curr);
const getRunnerTransform$1 = (runner) => runner.transforms;
...
let RunnerArray$1 = class RunnerArray {
  constructor() {
    this.runners = [];
    this.ids = [];
  }
...
const difference$1 = (a, b) => a.filter((x2) => !b.includes(x2));
extend$1(Runner$1, {
  attr(a, v) {
...
let Svg$1 = class Svg extends Container$1 {
  constructor(node, attrs2 = node) {
...
let Symbol$3 = class Symbol2 extends Container$1 {
  // Initialize node
  constructor(node, attrs2 = node) {
...
const textable$1 = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  __proto__: null,
  amove: amove$1,
  ax: ax$1,
  ay: ay$1,
...
let Text$1 = class Text extends Shape$1 {
  // Initialize node
  constructor(node, attrs2 = node) {
...
let Tspan$1 = class Tspan extends Shape$1 {
  // Initialize node
  constructor(node, attrs2 = node) {
...
let Circle$1 = class Circle extends Shape$1 {
  constructor(node, attrs2 = node) {
...
let ClipPath$1 = class ClipPath extends Container$1 {
  constructor(node, attrs2 = node) {
...
let ForeignObject$1 = class ForeignObject extends Element$1 {
  constructor(node, attrs2 = node) {
...
const containerGeometry$1 = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  __proto__: null,
  dmove: dmove$1,
  dx: dx$1,
  dy: dy$1,
...
register$1(G$1, "G");
let A$1 = class A extends Container$1 {
  constructor(node, attrs2 = node) {
...
register$1(A$1, "A");
let Mask$1 = class Mask extends Container$1 {
  // Initialize node
  constructor(node, attrs2 = node) {
...
let Stop$1 = class Stop extends Element$1 {
  constructor(node, attrs2 = node) {
...
let TextPath$1 = class TextPath extends Text$1 {
  // Initialize node
  constructor(node, attrs2 = node) {
...
let Use$1 = class Use extends Shape$1 {
  constructor(node, attrs2 = node) {
...
extend$1([Svg$1, Symbol$3, Image$2, Pattern$1, Marker$1], getMethodsFor$1("viewbox"));
...
class Toolbar {
  constructor(element, chartContext) {
    this.element = element;
    if (element) {
      if (chartContext) {
        this.chartContext = chartContext;
      } else {
        this.chartContext = new ChartContext(element);
      }
      this.injectStyles();
    }
  }
  injectStyles() {
    const styleId = `toolbar-styles-${this.chartContext.getInstanceId()}`;
    this.chartContext.injectStyles(ToolbarStyle, styleId);
  }
  createToolbarItem(itemName, icon, tooltip) {
    const itemContainer = this.chartContext.createElement("div");
    const image = new Image();
    image.src = icon;
    image.alt = tooltip || itemName;
    itemContainer.id = itemName;
    itemContainer.className = "toolbar-item";
    itemContainer.setAttribute("role", "button");
    itemContainer.setAttribute("tabindex", "0");
    if (tooltip) {
      itemContainer.setAttribute("data-tooltip", tooltip);
      itemContainer.setAttribute("aria-label", tooltip);
    }
  ...
  render({
    ...
    if (!this.element)
      return;
    const existingToolbar = this.chartContext.querySelector("#toolbar");
    existingToolbar == null ? void 0 : existingToolbar.remove();
    const container = this.chartContext.createElement("div");
    container.id = "toolbar";
    container.setAttribute("role", "toolbar");
    container.setAttribute("aria-label", "Chart controls");
    if (enableExport) {
    ...
    if (enableFitscreen) {
      const btnFitScreen = this.createToolbarItem(
        "fit-screen",
        ToolBarIcons[
          "fit-screen"
          /* FitScreen */
  ...
  destroy() {
    const toolbar = this.chartContext.querySelector("#toolbar");
    toolbar == null ? void 0 : toolbar.remove();
  }
}
...
const defaultNodeTemplate = (content) => `<div style='display: flex;justify-content: center;align-items: center; text-align: center; height: 100%;'>${content}</div>`;
const DefaultOptions = {
  ...
  enableToolbar: false,
  enableTooltip: false,
  expandCollapseButtonBGColor: "#FFFFFF",
...
const getEdge = (node, newParent, nodeWidth, nodeHeight, graphDirection) => {
...
const getExpandCollapseButtonPosition = (direction, nodeWidth, nodeHeight, buttonRadius) => {
  switch (direction) {
    case "top":
    case "bottom":
      return {
        x: nodeWidth / 2 - buttonRadius,
        y: nodeHeight - buttonRadius
      };
    case "left":
      return {
        x: nodeWidth - buttonRadius,
        y: nodeHeight / 2 - buttonRadius
      };
    case "right":
      return {
        x: -buttonRadius,
...
const applyButtonHoverEffects = (buttonGroup) => {
  const buttonClickArea = buttonGroup.findOne("circle");
  if (!buttonClickArea)
    return;
  const originalFill = buttonClickArea.attr("fill") || "#FFF";
  const originalStroke = buttonClickArea.attr("stroke") || "#ddd";
  const originalStrokeWidth = buttonClickArea.attr("stroke-width") || 1;
  const originalRadius = buttonClickArea.attr("r");
  buttonGroup.on("mouseenter", function() {
    buttonClickArea.attr({
      fill: "#f8f9fa",
      stroke: "#007bff",
      "stroke-width": 2,
      r: originalRadius * 1.1
    });
    buttonGroup.attr("style", "cursor: pointer; filter: drop-shadow(0 2px 4px rgba(0,0,0,0.2));");
  });
...
const highlightToPath = (selfNode, nodeMap, isHighlighted, options, chartContext) => {
  ...
  if (selfNode.parent) {
    const edge = chartContext.getElementById(`${selfNode.parent}-${selfNode.id}`);
    if (isHighlighted) {
      setAttributes(edge, {
  ...
  */
  static random(mode = "vibrant", t) {
    ...
    if (mode === "vibrant") {
      ...
      const c = (83 - 45) * random() + 45;
      const h = 360 * random();
      const color = new Color2(l, c, h, "lch");
      return color;
    } else if (mode === "sine") {
      t = t == null ? random() : t;
      const r = round(80 * sin(2 * pi * t / 0.5 + 0.01) + 150);
      ...
      const a = 256 * random() - 128;
      const b = 256 * random() - 128;
      const color = new Color2(l, a, b, "lab");
      return color;
    } else if (mode === "grey") {
      const grey = 255 * random();
      const color = new Color2(grey, grey, grey);
      return color;
    } else {
      throw new Error("Unsupported random color mode");
    }
  ...
  cmyk() {
    ...
    const k = Math.min(1 - r, 1 - g, 1 - b);
    if (k === 1) {
      return new Color2(0, 0, 0, 1, "cmyk");
    }
    const c = (1 - r - k) / (1 - k);
    const m = (1 - g - k) / (1 - k);
    const y2 = (1 - b - k) / (1 - k);
    const color = new Color2(c, m, y2, k, "cmyk");
    return color;
  }
  hsl() {
    const { _a, _b, _c } = this.rgb();
    ...
    const s = isGrey ? 0 : l > 0.5 ? delta / (2 - max - min) : delta / (max + min);
    const h = isGrey ? 0 : max === r ? ((g - b) / delta + (g < b ? 6 : 0)) / 6 : max === g ? ((b - r) / delta + 2) / 6 : max === b ? ((r - g) / delta + 4) / 6 : 0;
    const color = new Color2(360 * h, 100 * s, 100 * l, "hsl");
    return color;
  }
  init(a = 0, b = 0, c = 0, d = 0, space = "rgb") {
    a = !a ? 0 : a;
  ...
  */
  rgb() {
    if (this.space === "rgb") {
      ...
      const g = gU > bd ? 1.055 * pow(gU, 1 / 2.4) - 0.055 : 12.92 * gU;
      const b = bU > bd ? 1.055 * pow(bU, 1 / 2.4) - 0.055 : 12.92 * bU;
      const color = new Color2(255 * r, 255 * g, 255 * b);
      return color;
    } else if (this.space === "hsl") {
      let { h, s, l } = this;
      h /= 360;
  ...
  xyz() {
    ...
    const y2 = yU > 8856e-6 ? Math.pow(yU, 1 / 3) : 7.787 * yU + 16 / 116;
    const z = zU > 8856e-6 ? Math.pow(zU, 1 / 3) : 7.787 * zU + 16 / 116;
    const color = new Color2(x2, y2, z, "xyz");
    return color;
  }
  /*
  Input and Output methods
...
class EventTarget2 extends Base2 {
  addEventListener() {
  }
  dispatch(event, data2, options) {
...
class SVGNumber2 {
  ...
  init(value, unit) {
    ...
    if (typeof value === "number") {
      ...
      if (value instanceof SVGNumber2) {
        this.value = value.valueOf();
        this.unit = value.unit;
      }
    }
...
class Dom2 extends EventTarget2 {
  constructor(node, attrs2) {
    super();
    this.node = node;
    this.type = node.nodeName;
...
class Container2 extends Element2 {
  flatten() {
    this.each(function() {
      if (this instanceof Container2) {
        return this.flatten().ungroup();
      }
    });
    return this;
...
class Defs2 extends Container2 {
  constructor(node, attrs2 = node) {
...
class Gradient2 extends Container2 {
  constructor(type, attrs2) {
    super(
...
class Pattern2 extends Container2 {
  // Initialize node
  constructor(node, attrs2 = node) {
...
let Image$1 = class Image3 extends Shape2 {
  constructor(node, attrs2 = node) {
...
class PointArray2 extends SVGArray2 {
  // Get bounding box of points
  bbox() {
    let maxX = -Infinity;
    let maxY = -Infinity;
...
register(Line2, "Line");
class Marker2 extends Container2 {
  // Initialize node
  constructor(node, attrs2 = node) {
...
class Controller2 extends Stepper2 {
  constructor(fn) {
    super();
    this.stepper = fn;
  }
...
class Spring2 extends Controller2 {
  constructor(duration = 500, overshoot = 0) {
    super();
    this.duration(duration).overshoot(overshoot);
  }
...
class PID2 extends Controller2 {
  constructor(p = 0.1, i = 0.01, d = 0, windup = 1e3) {
    super();
    this.p(p).i(i).d(d).windup(windup);
  }
...
class PathArray2 extends SVGArray2 {
  // Get bounding box of path
  bbox() {
...
const morphableTypes = [NonMorphable2, TransformBag2, ObjectBag2];
...
class Polyline2 extends Shape2 {
  // Initialize node
  constructor(node, attrs2 = node) {
...
class Timeline2 extends EventTarget2 {
  // Construct a new timeline on the given element
...
class Runner2 extends EventTarget2 {
  constructor(options) {
    super();
    this.id = Runner2.id++;
...
let Symbol$1 = class Symbol3 extends Container2 {
  // Initialize node
  constructor(node, attrs2 = node) {
...
class ClipPath2 extends Container2 {
  constructor(node, attrs2 = node) {
...
class ForeignObject2 extends Element2 {
  constructor(node, attrs2 = node) {
...
register(A2, "A");
class Mask2 extends Container2 {
  // Initialize node
  constructor(node, attrs2 = node) {
...
class Paper {
  constructor(element, width2, height2, canvasStyle, chartContext) {
    this.chartContext = chartContext;
    this.width = width2;
    this.height = height2;
    element.innerHTML = "";
...
class Graph2 extends Paper {
  constructor(element, options, chartContext) {
    super(element, options.viewPortWidth, options.viewPortHeight, options.canvasStyle, chartContext);
    this.options = options;
    this.preservedPositions = /* @__PURE__ */ new Map();
  }
  calculateLayout() {
  ...
  collapse(nodeId) {
    ...
    if (node == null ? void 0 : node.children) {
      this.graph.nodes().forEach((id) => {
        ...
        if ((graphNode == null ? void 0 : graphNode.x) !== void 0 && (graphNode == null ? void 0 : graphNode.y) !== void 0) {
          this.preservedPositions.set(id, { x: graphNode.x, y: graphNode.y });
        }
      });
      this.nodeMap[nodeId] = {
        ...node,
  ...
  render({ keepOldPosition = false } = {}) {
    ...
    if (keepOldPosition && this.preservedPositions.size > 0) {
      this.graph.nodes().forEach((nodeId) => {
        const preservedPos = this.preservedPositions.get(nodeId);
        if (preservedPos) {
          const node = this.graph.node(nodeId);
          if (node) {
            node.x = preservedPos.x;
            node.y = preservedPos.y;
            this.graph.setNode(nodeId, node);
          }
        }
      });
    }
  ...
  renderLeafNode(nodeId, mainGroup, index) {
    ...
    const nodeContent = nodeTemplate(node[contentKey]);
    const templateElement = Paper.drawTemplate(nodeContent, { nodeHeight, nodeWidth });
    const combinedStyles = styles + (nodeStyle ? "; " + nodeStyle : "");
    templateElement.attr("style", combinedStyles);
    templateElement.attr("class", nodeClassName);
    group.add(templateElement);
    ...
    if (highlightOnHover) {
      group.on("mouseover", function() {
        ...
        if (selfNode) {
          highlightToPath(selfNode, graphInstance.nodeMap, true, options, graphInstance.chartContext);
        }
      });
      group.on("mouseout", function() {
        ...
        const selfNode = graphInstance.nodeMap[self2];
        if (selfNode) {
          highlightToPath(selfNode, graphInstance.nodeMap, false, options, graphInstance.chartContext);
        }
      });
    }
    if (enableTooltip) {
      ...
      group.on("mousemove", (e) => {
        const styles2 = getTooltipStyles({
        ...
        updateTooltip(graphInstance.chartContext, tooltipId, styles2, tooltipContent);
      });
      group.on("mouseout", (e) => {
        if (e.relatedTarget.tagName === "svg") {
          updateTooltip(graphInstance.chartContext, tooltipId);
        }
      });
    }
  ...
  renderNode(nodeId, mainGroup) {
    ...
    const combinedStyles = containerStyles + (nodeStyle ? "; " + nodeStyle : "");
    object.first().attr("style", combinedStyles);
    ...
    if (enableTooltip) {
      ...
      group.on("mousemove", (e) => {
        ...
        updateTooltip(graphInstance.chartContext, tooltipId, styles, tooltipContent);
      });
      group.on("mouseout", (e) => {
        if (e.relatedTarget.tagName === "svg") {
          updateTooltip(graphInstance.chartContext, tooltipId);
    ...
    if (enableExpandCollapse && (((_a = node.children) == null ? void 0 : _a.length) || ((_b = node.hiddenChildren) == null ? void 0 : _b.length))) {
      const buttonRadius = ExpandCollapseButtonSize / 2;
      const buttonPosition = getExpandCollapseButtonPosition(
        this.options.direction,
        nodeWidth,
        nodeHeight,
        buttonRadius
      );
      const isExpanded = !node.hiddenChildren;
      const buttonGroup = Paper.drawGroup(buttonPosition.x, buttonPosition.y);
      const buttonBackground = Paper.drawCircle({
        cx: buttonRadius,
        cy: buttonRadius,
        r: buttonRadius
      });
      buttonBackground.fill(this.options.expandCollapseButtonBGColor);
      buttonBackground.stroke({
        color: this.options.expandCollapseButtonBorderColor,
        width: 1
      });
      buttonGroup.add(buttonBackground);
      const iconSvg = isExpanded ? minusSvg : addSvg;
      const iconElement = Paper.drawTemplate(iconSvg, {
        nodeHeight: ExpandCollapseButtonSize,
        nodeWidth: ExpandCollapseButtonSize
      });
      buttonGroup.add(iconElement);
      ...
      applyButtonHoverEffects(buttonGroup);
    }
    if (this.options.onNodeClick) {
      group.on("click", () => {
        this.options.onNodeClick(node);
...
class ApexTree extends BaseChart {
  ...
  setupElementDimensions(width2, height2) {
    ...
    const calculatedHeight = height2 === "auto" ? calculatedWidth / 1.6 : Number(height2);
  ...
  render(data2) {
    ...
    if (this.options.enableToolbar) {
      const toolbar = new Toolbar(this.element, this.chartContext);
      toolbar.render({
        enableExport: true,
